...
def sequence(dna_seq): #when calculating the percentage of the sequence which is coding, this function does not consider the start and stop codons
   #import module
   import re
   ...
   count=len(within_codons) #count does not consider the start and stop codons
